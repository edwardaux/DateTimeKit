...
public enum DayOfWeek : Int {
	...
	*/
	...
	:param: The number of days to add. May be negative, in which case it will be subtracted
	:returns: The new day
	*/
	...
	:param: The number of days to subtract. May be negative, in which case it will be added
	:returns: The new day
	*/
...
extension DayOfWeek : DebugPrintable {
